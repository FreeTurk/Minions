...
public class CopperBlockBlock extends MinionsModElements.ModElement {
	@ObjectHolder("minions:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(MinionsModElements instance) {
		super(instance, 36);
	}

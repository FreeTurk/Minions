...
public class CompressedDirtBlock extends MinionsModElements.ModElement {
	@ObjectHolder("minions:compressed_dirt")
	public static final Block block = null;
	public CompressedDirtBlock(MinionsModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressed_dirt");
		}

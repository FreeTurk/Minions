...
public class CompressedIronBlockBlock extends MinionsModElements.ModElement {
	@ObjectHolder("minions:compressed_iron_block")
	public static final Block block = null;
	public CompressedIronBlockBlock(MinionsModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressed_iron_block");
		}

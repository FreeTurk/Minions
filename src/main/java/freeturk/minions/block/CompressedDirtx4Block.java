...
public class CompressedDirtx4Block extends MinionsModElements.ModElement {
	@ObjectHolder("minions:compressed_dirtx_4")
	public static final Block block = null;
	public CompressedDirtx4Block(MinionsModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressed_dirtx_4");
		}

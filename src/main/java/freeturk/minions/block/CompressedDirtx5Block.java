...
public class CompressedDirtx5Block extends MinionsModElements.ModElement {
	@ObjectHolder("minions:compressed_dirtx_5")
	public static final Block block = null;
	public CompressedDirtx5Block(MinionsModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressed_dirtx_5");
		}

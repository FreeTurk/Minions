...
public class CompressedDirtx3Block extends MinionsModElements.ModElement {
	@ObjectHolder("minions:compressed_dirtx_3")
	public static final Block block = null;
	public CompressedDirtx3Block(MinionsModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressed_dirtx_3");
		}

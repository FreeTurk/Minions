...
import freeturk.minions.item.CompressedIronNuggetItem;
import freeturk.minions.MinionsModElements;
import freeturk.minions.MinionsMod;

@MinionsModElements.ModElement.Tag
public class IronMinion4AIProcedure extends MinionsModElements.ModElement {
	public IronMinion4AIProcedure(MinionsModElements instance) {
		super(instance, 24);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MinionsMod.LOGGER.warn("Failed to load dependency x for procedure IronMinion4AI!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MinionsMod.LOGGER.warn("Failed to load dependency y for procedure IronMinion4AI!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MinionsMod.LOGGER.warn("Failed to load dependency z for procedure IronMinion4AI!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MinionsMod.LOGGER.warn("Failed to load dependency world for procedure IronMinion4AI!");
			return;
		}
			...
			if (((new Object() {
			...
			}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (0))) != 64)) {
				{
					...
					if (_ent != null) {
						...
						final ItemStack _setstack = new ItemStack(CompressedIronNuggetItem.block, (int) (1));

...
import freeturk.minions.block.CompressedDirtx4Block;
import freeturk.minions.MinionsModElements;
import freeturk.minions.MinionsMod;

@MinionsModElements.ModElement.Tag
public class DirtMinion5AIProcedure extends MinionsModElements.ModElement {
	public DirtMinion5AIProcedure(MinionsModElements instance) {
		super(instance, 82);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MinionsMod.LOGGER.warn("Failed to load dependency x for procedure DirtMinion5AI!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MinionsMod.LOGGER.warn("Failed to load dependency y for procedure DirtMinion5AI!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MinionsMod.LOGGER.warn("Failed to load dependency z for procedure DirtMinion5AI!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MinionsMod.LOGGER.warn("Failed to load dependency world for procedure DirtMinion5AI!");
			return;
		}
		...
		if ((((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == Blocks.DIRT.getDefaultState().getBlock())
			...
			if (((new Object() {
			...
			}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (0))) != 64)) {
				{
					...
					if (_ent != null) {
						...
						final ItemStack _setstack = new ItemStack(CompressedDirtx4Block.block, (int) (1));
			...
			}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (11))) != 64)) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
						...
						}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (11))) + 1));
						_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							if (capability instanceof IItemHandlerModifiable) {
								((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
							}
			...
			}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (12))) != 64)) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
						...
						}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (12))) + 1));
						_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							if (capability instanceof IItemHandlerModifiable) {
								((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
							}

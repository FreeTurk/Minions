...
public class CopperNuggetItem extends MinionsModElements.ModElement {
	@ObjectHolder("minions:copper_nugget")
	public static final Item block = null;
	public CopperNuggetItem(MinionsModElements instance) {
		super(instance, 40);
	}

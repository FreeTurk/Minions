...
public class CompressedIronNuggetItem extends MinionsModElements.ModElement {
	@ObjectHolder("minions:compressed_iron_nugget")
	public static final Item block = null;
	public CompressedIronNuggetItem(MinionsModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("compressed_iron_nugget");
		}
